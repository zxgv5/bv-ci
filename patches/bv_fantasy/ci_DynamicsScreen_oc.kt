...
fun DynamicsScreen(
    ...
    var currentFocusedKey by remember { mutableStateOf<String?>(null) }
    ...
    val showTip by remember {
        derivedStateOf { dynamicViewModel.dynamicVideoList.isNotEmpty() && currentFocusedKey != null }
    }
        ...
        ProvideListBringIntoViewSpec {
            LazyVerticalGrid(
                ...
                itemsIndexed(
                    ...
                    key = { _, item -> "video_${item.aid}" }
                ) { index, item ->
                    val videoKey = "video_${item.aid}"
                    SmallVideoCard(
